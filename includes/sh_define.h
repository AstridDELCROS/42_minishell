...
/*   Updated: 2021/01/02 15:49:43 by mboivin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** Flags
**
** Pourquoi volatile et sig_atomic_t : http://shtroumbiniouf.free.fr/CoursInfo/Systeme2/TP/CoursSignaux/Volatile.html
**
** g_done: État du programme : terminé ou pas terminé (true ou false)
** g_char_dev: Si un char device (/dev/random ou /dev/zero) a été ouvert comme rediction (true ou false)
*/
